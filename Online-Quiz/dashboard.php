...
<head>
    ...
    <title>Dashboard | Certification Portal</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Certification Portal</b></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        $result = mysqli_query($con,"SELECT * FROM certifications") or die('Error');
                        echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                        <tr><td><center><b>id</b></center></td><td><center><b>EMPLOYEE NAME</b></center></td><td><center><b>CSP</b></center></td><td><center><b>Cer_Name</b></center></td><td><center><b>Cer_level</b></center></td><td><center><b>Cer_id</b></center></td><td><center><b>cer_date</b></center></td><td><center><b>Cer_expiry</b></center></td><td><center><b>Cer_validity</b></center></td><td><center><b>Certificate</b></center></td><td><center><b>Action</b></center></td></tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) 
                        {
                            $name = $row['emp_name'];
                            $csp = $row['csp'];
                            $cername=$row['cer_name'];
                            $cerlevel = $row['cer_level'];
                            $cerid = $row['cer_id'];
                            $cerdate=$row['cer_date'];
                            $cerexpiry = $row['cer_expiry'];
                            $validity = $row['validity'];
                            $certification=$row['certification'];
                            
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td><td><center>'.$csp.'</center></td><td><center>'.$cername.'</center></td><td><center>'.$cerlevel.'</center></td><td><center>'.$cerid.'</center></td><td><center>'.$cerdate.'</center></td><td><center>'.$cerexpiry.'</center></td><td><center>'.$validity.'</center></td><td><center>'.$certification.'</center></td><td><center><a title="Delete User" href="update.php?demail='.$name.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
