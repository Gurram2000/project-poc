<?php
  ...
  if(isset($_POST['submit']))
  {
      ...
      $name = $_POST['emp_name'];
      $csp = $_POST['csp'];
      $cername=$_POST['cer_name'];
      $cerlevel = $_POST['cer_level'];
      $cerid = $_POST['cer_id'];
      $cerdate=$_POST['cer_date'];
      $cerexpiry = $_POST['cer_expiry'];
      $validity = $_POST['validity'];
      $certification=$_POST['certification'];
      $insert=mysqli_query($con,"INSERT INTO certifications VALUES  ('$name','$csp','$cername','$cerlevel','$cerid','$cerdate','$cerexpiry','$validity','$certification')") or die('Error61');
      header("location:dashboard.php?q=0");
