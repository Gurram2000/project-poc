...
<html>
	<head>
		...
		<title>Register | Certification Portal </title>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Certification Portal</h4></center><br>
